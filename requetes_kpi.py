...
def get_avg_price(marques: list|str, modeles: list|str, 
                  annee_min: int, annee_max: int, 
                  km_min: int, km_max: int, 
                  boite: list, energie: list, 
                  prix_min: int, prix_max: int, 
                  user_role: str, cylindre: str = "", 
                  puissance: int = 0) -> float:
    """
