...
:::{.fragment}
**Données d'entrainement** : échantillon de <span style="color:#4682B4">**80%**</span> d'observations de la marque
...
:::{.fragment}
La quantité de données étant importantes, l'optimisation des paramètres peut-être très longue.⏳
::: 
...
- Open source
- Rapide et gère grand ensembles de données
...
- Docstring pour chaque fonctions et modules
...
- Avoir une base de données actualisé et récente
