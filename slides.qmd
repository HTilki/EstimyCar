...
:::{.fragment}
La quantité de données étant importantes, l'optimisation des paramètres peut-être très longues.⏳
::: 

:::{.fragment}
C'est pour cette raison que plusieurs grilles ont été testé en amont afin de determiner une grille finale, voici les résultats intermédiaires.
:::
