...
def split_cylindre(data: pl.DataFrame) -> pl.DataFrame:
    ...
    ## Example:
        ...
        |--------------------------------------|------------|-----------|-----------|---------------------|-------------|---------- |-------------|----------------|----------|------------|------------------|------------|
        | "1.6 BLUEHDI 100 SHINE"              | "1.6"      | "BLUEHDI" | "100"     | "SHINE"             | null        | "BLUEHDI" | "100"       | null           | null     | null       | null             | null       |
        | "1.2 PURETECH 130 FEEL PACK BUSINESS"| "1.2"      | "PURETECH"| "130"     | "FEEL PACK BUSINESS"| null        | "PURETECH"| "130"       | null           | null     | null       | null             | null       |
        ...
        | "320ch 75kWh"                        | null       | null      | null      | null                | null        | null      | null        | null           | null     | "320ch"    | "75kWh"          | null       |
...
def supp_na(data: pl.DataFrame) -> pl.DataFrame:
    ...
    ## Example:
        ...
        | BMW    |
    """
    return data.drop_nulls(subset="marque")
